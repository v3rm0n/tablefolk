...
export function liveRulesHash() {
  return parseHash256(sha256(encodeCanonical({ id: "sasku-match-candidate/3", cards, hand, scoring, match,
    setupRound: 0, round: FIRST_ROUND, dealer: FIRST_DEALER, deal: FIRST_DEAL,
    beacon: "none; key-only setup; seat-order-fixed",
    shuffle: "candidate-ristretto-4x9-parity-ac4fb67-sha512-cbor-v1",
    dealShares: "four-donor-all-other-positions-proof-batches-v1",
